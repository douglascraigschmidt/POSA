package edu.vandy.tasktesterframeworklib.model.interfaces;
 ...
 */
public interface ModelStateInterface<TaskTuple extends AbstractTaskTuple> {
    /**
     ...
     */
    default public ProgramState getCurrentState() {
     ...
     */
    default public void setState(ProgramState state) {
     ...
     * @return The AbstractTaskTuple at the given position.
     */
