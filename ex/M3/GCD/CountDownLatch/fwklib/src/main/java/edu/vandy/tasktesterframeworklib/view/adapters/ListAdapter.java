package edu.vandy.tasktesterframeworklib.view.adapters;
 ...
 */
public class ListAdapter<TaskTuple extends AbstractTaskTuple>
	extends ArrayAdapter<TaskTuple> {
    /**
     ...
     */
    private ArrayList<TaskTuple> mTaskList;
    ...
    /**
     * Called each time the Adapter needs to create a new View for display on the ListView.
     */
    @NonNull
    @Override
    public View getView(int position,
        ...
        final ViewHolder<TaskTuple> viewHolder;
        if (convertView == null) {
            ...
            viewHolder = (ViewHolder<TaskTuple>) convertView.getTag();

        // get your data object
        final TaskTuple task = mTaskList.get(position);
     ...
     */
    final static class ViewHolder<TaskTuple extends AbstractTaskTuple> {
        /**
        ...
        void setNewTask(TaskTuple t) {
            mTvTaskDesc.setText(String.format("%s", t.mFuncName));
            mPbTask.setProgress(t.mProgressStatus);
            mTvTaskCount.setText(String.format("%d%%", t.mProgressStatus));
        }
     ...
     */
    @Override
    public TaskTuple getItem(int position) {
     ...
     */
    public int addTask(TaskTuple newTask) {
