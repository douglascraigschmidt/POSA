 ...
 * framework to determine if n random numbers are prime or not.  In
 * addition, runtime configuration changes are handled relatively
 * gracefully.
 */
   ...
   /**
    ...
    public void startComputations(int count) {
        ...
        if (count <= 0) 
            ...
            // Only allocate as many executors as their are processor
            // cores since determining primaility is a CPU-bound
            // computation.
            mExecutor =
